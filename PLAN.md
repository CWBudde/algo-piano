...
- **Offline structural tier.** The original “Helmholtz eigensolve” wording was
  ...
  `body-modal-transfer-v1` artifact. `algo-piano` requires the released
  `algo-pde v0.3.0` module and runs its `cmd/plate-modes` producer; no eigensolve
  occurs in the fitting loop.
